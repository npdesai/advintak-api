...
namespace IPAM_Common
{
    public class IPAddressAnalysis
    {
        ...
        public static IPAddress GetClasslessNetworkAddress(IPAddress ipa, SubnetmaskHelper sMask)
        {
        ...
        public static IPAddress GetClasslessBroadcastAddress(IPAddress ipa, SubnetmaskHelper sMask)
        {
            if (ipa.AddressFamily != AddressFamily.InterNetwork && ipa.AddressFamily != AddressFamily.InterNetworkV6)
            {
                throw new ArgumentException("Only IPv4 and IPv6 addresses are supported.");
        ...
        public static SubnetmaskHelper GetClassfullSubnetMask(IPAddress ipa)
        {
            if (ipa.AddressFamily != AddressFamily.InterNetwork)
            {
                throw new ArgumentException("Only IPv4 addresses are supported for classfull address calculations.");
            ...
            SubnetmaskHelper sm = new SubnetmaskHelper();
